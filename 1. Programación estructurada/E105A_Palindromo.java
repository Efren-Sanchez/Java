...
public class E105A_Palindromo {
    public static void main(String[] args) {
        ...
        System.out.println("Introduce una palabra o frase para averiguar si es un palindromo: ");
    ...
    public static boolean comprobarPalindromo(String p) {
        // Invierto la cadena original
        String s = new StringBuilder(p).reverse().toString();
        
        // Recorro las dos cadenas a la par comparando
