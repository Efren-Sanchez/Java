 ...
 * raiz cuadrada, ecuación de 2º grado. El programa debe usar un bucle while o 
 * do while para ofrecer operaciones al usuario hasta que pulse 0.
 * 
 ******************************************************************************/

import java.util.Scanner;

public class E059A_CalculadoraV2 {
    public static void main(String[] args) {

		System.out.println("\n\n\n* E059A_CalculadoraV2 *\n\n  --- Inicio del programa ---\n\n");

        Scanner sc = new Scanner(System.in);
        int opcion = -1;    // Inicializamos la opcion a un valor que cumpla la condición del bucle para que entre la primera vez
