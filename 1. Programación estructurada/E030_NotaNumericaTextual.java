...
public class E030_NotaNumericaTextual {
    public static void main(String[] args) {
		...
		if (nota < 0 || nota > 10)
		{
			System.out.println("** Error: la nota introducida no es correcta. Debe estar entre 0 y 10. **");
		}

		// Nos aprovechamos del orden en el que hacemos las comprobaciones para no preguntar por el intervalor inferior y superios, sino solo por el inferior
		else if (nota < 5)
		{
