...
public class E112A_FibonacciRecursivo {
	public static void main(String[] args) {
		...
		do {
			...
			for (int i = 1; i <= numero; i++) System.out.print(fibonacciRecursivo(i) + ", ");	
			t1Fin = System.nanoTime(); 
			t1Total = t1Fin - t1Ini;
			System.out.println("\n" + t1Total + " nanosegundos invertidos en este proceso.\n");

			t1Ini = System.nanoTime();
			for (int i = 1; i <= numero; i++) System.out.print(fibonacciIterativo(i) + ", ");	
			t1Fin = System.nanoTime(); 
			t1Total = t1Fin - t1Ini;
			System.out.println("\n" + t1Total + " nanosegundos invertidos en este proceso.\n");
	...
	{	
		...
		if (n <= 2) return 1; 
		// Caso general
		else		return (fibonacciRecursivo(n -1) + fibonacciRecursivo(n - 2)); // Llamada a la propia función
	}
