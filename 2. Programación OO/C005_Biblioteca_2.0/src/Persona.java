...
public class Persona {
    ...
    public static void main(String[] args) {
        ...
        if (p4.equals(p2))
            System.out.println("\n\nLos objetos p2 y p4 son iguales.");
        else
            System.out.println("\n\nLos objetos p2 y p4 NO son iguales.");

        if (p1.equals(p2))
            System.out.println("\n\nLos objetos p1 y p2 son iguales.");
        else
            System.out.println("\n\nLos objetos p1 y p2 NO son iguales.");
    }
}
