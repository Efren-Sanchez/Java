...
public class Libro {
    ...
    public static void main(String[] args) {
        Libro l1 = new Libro();
        Libro l2 = new Libro("Hyperion", "Dan Simmons", "111-1-111-111111", 7);
        Libro l3 = new Libro(l2);
        Libro l4 = new Libro(l2);
        ...
        l3.setTitulo("La caida de Hyperion");
        ...
        if (l4.equals(l2))
            System.out.println("\n\nLos objetos l2 y l4 son iguales.");
        else
            System.out.println("\n\nLos objetos l2 y l4 NO son iguales.");

        if (l3.equals(l2))
            System.out.println("\n\nLos objetos l2 y l3 son iguales.");
        else
            System.out.println("\n\nLos objetos l2 y l3 NO son iguales.");
    }
}