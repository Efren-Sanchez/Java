...
- Herencia de clases con abstracción

## Clases

- [Libro](src/Libro.java): representa un libro presente en la biblioteca.
- [Persona](src/Persona.java): clase abstracta padre que representa a cualquier persona.
...
- [Biblioteca](src/Biblioteca.java): representa a toda la biblioteca, con sus trabajadores, usuarios, libros y préstamos.
